...
export default function Barbers() {
  ...
  // Función reutilizable para cargar el equipo
  ...
  // useEffect con array vacío → corre solo al montar
  useEffect(() => {
    let activo = true // evita memory leaks
    ...
    cargar()
    return () => { activo = false } // cleanup al desmontar
  }, [])
